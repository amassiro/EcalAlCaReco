...
# with command line options: step21 --mc --eventcontent AODSIM,ALCARECO runUnscheduled --datatier AODSIM,ALCARECO --conditions 100X_upgrade2018_realistic_v11 --step RAW2DIGI,RECO,RECOSIM,EI,ALCA:EcalUncalZElectron --nThreads 8 --era Run2_2018
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras

process = cms.Process('MYRECO',eras.Run2_2018)
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step21_RAW2DIGI_RECO_RECOSIM_EI_ALCA.root'),
...
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.reconstruction_step,process.recosim_step,process.eventinterpretaion_step,process.pathALCARECOEcalUncalZElectron,process.pathALCARECOEcalUncalZSCElectron,process.endjob_step,process.AODSIMoutput_step,process.ALCARECOStreamEcalUncalZElectronOutPath)
